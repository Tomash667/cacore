...
__declspec(dllimport) VLD_UINT VLDMemCheckpoint();
...
__declspec(dllimport) VLD_UINT VLDReportLeaksSince(VLD_UINT leakId);
...
__declspec(dllimport) VLD_UINT VLDGetLeaksCountSince(VLD_UINT leakId);
...
__declspec(dllimport) void VLDMarkLeaksAsReportedSince(VLD_UINT leakId);
